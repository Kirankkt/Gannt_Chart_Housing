...
def create_gantt_chart(df_filtered, color_by_status=False):
    ...
    # Remove the fullscreen toggle so that the sidebar remains visible
    return fig
...
with tabs[0]:
    ...
    with col2:
        ...
        # Pass configuration to remove the fullscreen toggle so that the sidebar remains visible
